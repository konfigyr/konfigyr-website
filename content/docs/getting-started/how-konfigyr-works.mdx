...
<div className="space-y-4">
  <Card title="1. Configuration is king">
    Configuration metadata should is considered a first-class citizen of the application source code,
    not a separate artifact. The Spring Boot configuration metadata is used to validate configuration at the source.
  </Card>

  <Card title="2. Correctness">
    Developers should never ship broken or invalid configs. A type-safe UI prevents typos, missing fields,
    and invalid values.
  </Card>

  <Card title="3. Security and distribution">
    Configuration must be secure, isolated, and easy to distribute. Encryption, keysets, and multiple delivery
